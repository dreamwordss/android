...
import com.lbl.codek3demo.video.BLVideoActivity;
...
public class VideoCell extends BaseViewHolder<MvpBean> {
    private Context context;
    RelativeLayout layoutTitle;

    public VideoCell(View view, Context context) {
        super(view);
    ...
    private void initView(View view) {
        ...
        layoutTitle.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(context, BLVideoActivity.class);
