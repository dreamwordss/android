...
import com.lbl.codek3demo.photo.BLPhotoActivity;
...
public class TextCell extends BaseViewHolder<MvpBean> {
    private Context context;
    RelativeLayout layoutTitle;

    public TextCell(View view, Context context) {
        super(view);
    ...
    private void initView(View view) {
        ...
        layoutTitle.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(context, BLPhotoActivity.class);
