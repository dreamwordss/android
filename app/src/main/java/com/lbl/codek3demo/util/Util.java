...
public class Util {
    ...
    //cache文件夹下
    public static File getAppFilePath(Context context, String fileName) {
        File dateFile = new File(getCacheDirectory(context, true), fileName);
        if (!dateFile.exists()) {
            dateFile.mkdirs();
        }
        return dateFile;
    ...
    //系统目录下的小红唇视频音乐路径
    public static File getOldAppResoucePath(Context context) {
        return getAppFilePath(context, "sucai2");
    }
    public static File getAppResoucePath(Context context) {
        return getAppFilePath(context, "sucai3");
    }

    //系统目录下的视频主题素材路径
    public static File getAppVideoThemePath(Context context) {
        return getAppFilePath(context, "videostyle");
    }

    //系统目录下的视频贴纸素材路径
    public static File getAppVideoStickerPath(Context context) {
        return getAppFilePath(context, "videosticker");
    }

    //系统目录下的视频字幕素材路径
    public static File getAppVideoCaptionstylePath(Context context) {
        return getAppFilePath(context, "videocaption");
    }

    //系统目录下的视频滤镜素材路径
    public static File getAppVideofxPath(Context context) {
        return getAppFilePath(context, "videofx");
    }

    //系统目录下的视频转场素材路径
    public static File getAppVideoTransition(Context context) {
        return getAppFilePath(context, "videotransition");
    }
    public static File getAppEncodeTmpPath(Context context) {
        return getAppFilePath(context, "encodeTmp");
    }
    ...
    //获取文字描述地址
    public static String getAppPublishTextPath(String fileTag) {
        String result = Environment.getExternalStorageDirectory()
                + "/encodeTmp/editpic/" + fileTag + "/content.txt";
        File file = new File(result);
        if (file.exists() && file.isDirectory()) {
        } else {
            file.mkdirs();
    ...
    //创建图片发布模板的 临时文件夹
    public static String getAppPublishPhotoTmpPath(String fileTag) {
        String result = Environment.getExternalStorageDirectory()
                + "/encodeTmp/editpic/" + fileTag;
        File file = new File(result);
        if (file.exists() && file.isDirectory()) {
        } else {
            file.mkdirs();
    ...
    //视频裁剪 合并地址
    public static File getAppEncodeMarksTmpPath(Context context) {
        return getAppFilePath(context, "marks");
    }

    //图片处理 存放地址
    public static File getAppEditPicturePath(Context context) {
        return getAppFilePath(context, "editpic");
    }
    ...
    public static File getCachedirPath(Context context) {
        return getAppFilePath(context, "cache");

    }

    public static File getAdDirPath(Context context) {
        return new File(getCachedirPath(context), "ads");
    }

    public static File getToolBarDirPath(Context context) {
        return new File(getCachedirPath(context), "toolbar");
    }

    public static File getDownloadTempPath(Context context) {
        return getAppFilePath(context, "download_tmp");
    }
    ...
    // public static RecorderParameters getRecorderParameter(int
    // currentResolution) {
...
//                e.printStackTrace();
    ...
    //获取cache路径
    public static File getCacheDirectory(Context context, boolean prefreExternal) {
